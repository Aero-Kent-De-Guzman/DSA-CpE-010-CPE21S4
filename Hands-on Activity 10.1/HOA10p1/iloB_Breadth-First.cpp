...
std::ostream &operator<<(std::ostream &os, const Graph<T> &G)
{
    ...
    return os; // optional, but it keeps an triangle error if it is not added. But the program still will work without it...
}
...
public:
    ...
    // template <typename T> || this is unnecessary, it keeps returning an error if this is added...
...
void test_BFS()
{
    std::cout << "Starting test_BFS" << std::endl; // I added this, idk why but my compiler wont output
                                                   // anything in the terminal if I leave it as is...
